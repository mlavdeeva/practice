...
class Calculator(QtWidgets.QDialog):
    def __init__(self, parent=None):
        ...
        self.leMathojidanie.setValidator(self.validatorInt)  # разрешается ввод только целых чисел
        ...
        self.leDispersion.setValidator(self.validatorInt)  # разрешается ввод только целых чисел
        ...
        self.leOtkloneniye.setValidator(self.validatorInt)  # разрешается ввод только целых чисел
